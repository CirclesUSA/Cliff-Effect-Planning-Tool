...
<form id="cl_currentbenefits" enctype="multipart/form-data" method="POST" action="cl_infos.php" novalidate="novalidate" style="padding: 10px;" autocomplete="on">
	...
	<div style="text-align: center; float: right;">
 	...
 	<div style="text-align: center; float: left; width: 100%;">
          <p class="p1">
            <br>Circle Leader Current Benefits
          </p>
          <hr class="org-hr">
          	<p class="p2">
            <br>Are you receiving any of the following . . . <br><br></p>
        </div>
    <!-- END HEADER -->
...
/*window.onload = function()
    ...
    document.getElementById("NoGoRow").style.display="none";
  }*/
function CheckButtons()
  {
    ...
    if (x2==true && x4==true && x6==true && x8==true && x10==true)
    	{
    	document.getElementById("NoGoRow").style.display="block";
    	document.getElementById("DoneButtonRow").style.display="none";
    	return;
    	} 
    if (x1==true || x2==true)
...
<div class="container">
	...
	<tr><td align="right"><fieldset id="ChildCareset" style="border:0;"><input type="radio" id="ChildCareY" name="cur_childcare" value="Yes" onchange="CheckButtons();"/><span class="p3">Yes</span>
	<input type="radio" id="ChildCareN" name="cur_childcare" value="No" onchange="CheckButtons()";/><span class="p3">No</span></fieldset></td><td><span class="p2">Child Care</span></td>
	</tr>
  <!--tr><td colspan="2" align="center" class="p2"><hr class="org-hr"></td></tr-->
  <tr><td align="right"><fieldset id="FoodStampsSet" style="border:0;"><input type="radio" id="FoodStampsY" name="cur_foodstamps" value="Yes" onchange="CheckButtons();"/><span  class="p3">Yes</span>
																<input type="radio" id="FoodStampsN" name="cur_foodstamps" value="No" onchange="CheckButtons();"/><span  class="p3">No</span></fieldset></td><td><span class="p2">Food Stamps</span> 
  </td></tr>
  <!--tr><td colspan="2" align="center" class="p2"><hr class="org-hr"></td></tr-->
	<tr><td align="right"><fieldset id="HudSubsidySet" style="border:0;"><input type="radio" id="HudSubsidyY" name="cur_hudsubsidy" value="Yes" onchange="CheckButtons();"/><span  class="p3">Yes</span>
																	<input type="radio" id="HudSubsidyN" name="cur_hudsubsidy" value="No" onchange="CheckButtons();"/><span  class="p3">No</span></fieldset></td><td><span class="p2">HUD Subsidy</span>
	</td></tr>
  <!--tr><td colspan="2" align="center" class="p2"><hr class="org-hr"></td></tr-->
  <tr><td align="right"><fieldset id="TANFset" style="border:0;"><input type="radio" id="TANFY" name="cur_tanf" value="Yes" onchange="CheckButtons();"/><span  class="p3">Yes</span>
																<input type="radio" id="TANFN" name="cur_tanf" value="No" onchange="CheckButtons();"/><span  class="p3">No</span></td><td><span class="p2">TANF</span>
 </td></tr>
  <!--tr><td colspan="2" align="center" class="p2"><hr class="org-hr"></td></tr-->
  </td></tr>
  <tr><td align="right"><fieldset id="Medicalset" style="border:0;"><input type="radio" id="MedicalY" name="cur_medical" value="Yes" onchange="CheckButtons();"/><span  class="p3">Yes</span>
																<input type="radio" id="MedicalN" name="cur_medical" value="No" onchange="CheckButtons();"/><span  class="p3">No</span></td><td><span class="p2">Medical</span>
	</td></tr>
  <!--tr><td colspan="2" align="center" class="p2"><hr class="org-hr"></td></tr>
	<tr id="DoneButtonRow"><td colspan="2" align="right">
 </td></tr-->
	</table>
	<div id="DoneButtonRow" style="float:right;" class="hidden_element">
 <button type="submit" class="donebutton" onclick="" >Continue to input form --></button>
	</div>
		<div id="NoGoRow" class="hidden_element"><br><br><span class="p4">Thank You.  However, we cannot proceed at this time.  This tool is designed to evaluate future benefits based on those you already have.  Please work with your Allies to apply for benefits and then come back to the Planning Tool!</span><br>
		</div><br><br>
</div>
 <hr class="org-hr">
	<!--/div-->
