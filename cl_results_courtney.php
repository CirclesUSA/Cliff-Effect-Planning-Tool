...
.centeredsandbox {
  margin: auto;
  width: 60%;
  border: 6px ridge rgb(255, 0, 0);
  color: rgb(255, 0, 0);
  padding: 10px;
  background-image: url("http://cusacept.vinceco.com/SANDBOX/images/sandbox.jpg");
...
.sandboxtext {
  ...
  .org-hr {
	...
	<body>
	<div id="SANDBOX" class="centeredsandbox"><img src="images/SmileyFace.jpg" alt="SMILEYFACE" width="50px" height="50px"><span class="sandboxtext">THE SANDBOX</span></div>
	<!-- BEGIN CUSA HEAD -->
<div id="MainDIV" class="centered">
	...
	?>
	<button class="printbutton" id="PrintButton" type="button" onclick="PrintGraph()">Print</button>
          </p>
          <hr class="org-hr">
        </div>
	...
	function PrintGraph() {
			...
			var mainprint = document.getElementById("MainDIV");
            var printWindow = window.open('', '', 'height=400,width=800');
            printWindow.document.write('<html><head><title></title>');
			printWindow.document.write( "<link rel=\"stylesheet\" href=\"printResults.css\" type=\"text/css\" media=\"print\"/>" );
            printWindow.document.write('</head><body >');
            printWindow.document.write(mainprint.innerHTML);
            printWindow.document.write('</body><footer>'); 
			printWindow.document.write('Copyright ');
			printWindow.document.write(new Date().getFullYear());
			printWindow.document.write(' - Circles USA');
			printWindow.document.write('</footer></html>');
