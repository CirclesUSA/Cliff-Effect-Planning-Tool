...
By clicking on the link button below you signify that you understand and agree with this disclaimer.<br><br>
  ...
  <button type="reset" onclick="location.href='cl_currentbenefits.php'" style="border: none; color: white; padding: 7px 10px; text-align: center; text-decoration: none; display: inline-block; font-size: 15px; font-weight: bold; background-color: rgb(0, 163, 222); font-family: Helvetica, Arial; background-image: none;">I Agree!</button>
  </div>
