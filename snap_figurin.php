...
//LOOKUP RESOURCE LIMITS
      ...
      if (($vehicle_equity_allowed=="0")||($vehicle_equity_allowed=="-1")){$EVvehicle1="0"; $EVothervehicle="0"; $vehicle_resource_exclusion="0";}
...
//LOOKUP SNAP DISREGARD PERCENTAGE
      ...
      if ($people_count>6){$std_people_count=6;}else{$std_people_count=$people_count;}
      $whichdeduct="std_deduct_h".$std_people_count;
