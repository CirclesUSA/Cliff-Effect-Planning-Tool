<?php
	...
	$cur_foodstamps=$_POST["cur_foodstamps"];
	$cur_tanf=$_POST["cur_tanf"];
	$cur_childcare=$_POST["cur_childcare"];
	$cur_medical=$_POST["cur_medical"];
	$cur_hudsubsidy=$_POST["cur_hudsubsidy"];
	$TotalEarned=$_POST["GrossIncomeAmount"];
	$UnEarnedSSIEtc=$_POST["UnEarnedSSIEtc"];
	echo "<br>This_GrossIncomeAmountIncome == ".$GrossIncomeAmount."<br><br>";
	echo "<br>UnEarnedSSIEtc == ".$UnEarnedSSIEtc."<br><br>";
	/*
	$cur_foodstamps="No";
	$cur_tanf="No";
	$cur_childcare="No";
	...
	*/
		...
		echo "<tr><td>Total Fields: </td><td>$i</td></tr></table><br><br>";*/
?>
<!DOCTYPE HTML>
<html>
<?php
...
<?php
      $x=1;
		 ...
		 if ($cur_foodstamps=="Yes")
			{ echo "<tr><td style=\"font-weight:bold;\">Food Stamps</td>";
      ...
      echo $CCIS_row."</tr>";
		...
		<?php
					$x=1;
							while ($x<=$plotpoints)
								{
									$This_SpendingPower=${"this_monthly".$x};
									if (isset($this_snap1)){$This_SpendingPower=$This_SpendingPower+${"this_snap".$x};}
									if (isset($this_tanf1)){$This_SpendingPower=$This_SpendingPower+${"this_tanf".$x};}
									if (isset($this_ccis1)){$This_SpendingPower=$This_SpendingPower+${"this_ccis".$x};}
									if (isset($this_magi1)){$This_SpendingPower=$This_SpendingPower+${"this_magi".$x};}
									if (isset($this_hud1)){$This_SpendingPower=$This_SpendingPower+${"this_hud".$x};}
    ...
    <table border=0 cellpadding=2 cellspacing=2 width="25%" class="form-els" style="font-size: 14px;">
          <tr>
...
$(function () {
var MonthEXP = (".$_POST['PostMonthlyExpenses'].");
var fpig1 = Math.round(".$fpig100.");
var fpig2 = Math.round(".$fpig200.");
var curr = ".$current_line.";
var cofl1 = ".$costofliving.";
var th1 = (".$this_hourly1.").toFixed(2);
var th2 = (".$this_hourly2.").toFixed(2);
var th3 = (".$this_hourly3.").toFixed(2);
var th4 = (".$this_hourly4.").toFixed(2);
var th5 = (".$this_hourly5.").toFixed(2);
var th6 = (".$this_hourly6.").toFixed(2);
var th7 = (".$this_hourly7.").toFixed(2);
var th8 = (".$this_hourly8.").toFixed(2);
var th9 = (".$this_hourly9.").toFixed(2);
var th10 = (".$this_hourly10.").toFixed(2);
var th11 = (".$this_hourly11.").toFixed(2);
var th12 = (".$this_hourly12.").toFixed(2);
var th13 = (".$this_hourly13.").toFixed(2);
var th14 = (".$this_hourly14.").toFixed(2);
var th15 = (".$this_hourly15.").toFixed(2);
var th16 = (".$this_hourly16.").toFixed(2);
var th17 = (".$this_hourly17.").toFixed(2);
var th18 = (".$this_hourly18.").toFixed(2);
var th19 = (".$this_hourly19.").toFixed(2);
";

if ($cur_tanf=="Yes")
{
echo "var tf1 = Math.round(".$this_tanf1.");
var tf2 = Math.round(".$this_tanf2.");
var tf3 = Math.round(".$this_tanf3.");
var tf4 = Math.round(".$this_tanf4.");
var tf5 = Math.round(".$this_tanf5.");
var tf6 = Math.round(".$this_tanf6.");
var tf7 = Math.round(".$this_tanf7.");
var tf8 = Math.round(".$this_tanf8.");
var tf9 = Math.round(".$this_tanf9.");
var tf10 = Math.round(".$this_tanf10.");
var tf11 = Math.round(".$this_tanf11.");
var tf12 = Math.round(".$this_tanf12.");
var tf13 = Math.round(".$this_tanf13.");
var tf14 = Math.round(".$this_tanf14.");
var tf15 = Math.round(".$this_tanf15.");
var tf16 = Math.round(".$this_tanf16.");
var tf17 = Math.round(".$this_tanf17.");
var tf18 = Math.round(".$this_tanf18.");
var tf19 = Math.round(".$this_tanf19.");
";
}

if ($cur_foodstamps=="Yes")
{
echo "var ts1 = ".$this_snap1.";
var ts2 = (".$this_snap2.");
var ts3 = (".$this_snap3.");
var ts4 = (".$this_snap4.");
var ts5 = (".$this_snap5.");
...
var ts8 = (".$this_snap8.");
var ts9 = (".$this_snap9.");
var ts10 = (".$this_snap10.");
var ts11 = (".$this_snap11.");
var ts12 = (".$this_snap12.");
var ts13 = (".$this_snap13.");
var ts14 = (".$this_snap14.");
var ts15 = (".$this_snap15.");
var ts16 = (".$this_snap16.");
var ts17 = (".$this_snap17.");
var ts18 = (".$this_snap18.");
var ts19 = (".$this_snap19.");";
}

if ($cur_childcare=="Yes")
{
echo "var cc1 = Math.round(".$this_ccis1.");
var cc2 = Math.round(".$this_ccis2.");
var cc3 = Math.round(".$this_ccis3.");
var cc4 = Math.round(".$this_ccis4.");
var cc5 = Math.round(".$this_ccis5.");
var cc6 = Math.round(".$this_ccis6.");
var cc7 = Math.round(".$this_ccis7.");
var cc8 = Math.round(".$this_ccis8.");
var cc9 = Math.round(".$this_ccis9.");
var cc10 = Math.round(".$this_ccis10.");
var cc11 = Math.round(".$this_ccis11.");
var cc12 = Math.round(".$this_ccis12.");
var cc13 = Math.round(".$this_ccis13.");
var cc14 = Math.round(".$this_ccis14.");
var cc15 = Math.round(".$this_ccis15.");
var cc16 = Math.round(".$this_ccis16.");
var cc17 = Math.round(".$this_ccis17.");
var cc18 = Math.round(".$this_ccis18.");
var cc19 = Math.round(".$this_ccis19.");
";
}

if ($cur_medical=="Yes")
{
echo "var mg1 = Math.round(".$this_magi1.");
var mg2 = Math.round(".$this_magi2.");
var mg3 = Math.round(".$this_magi3.");
var mg4 = Math.round(".$this_magi4.");
var mg5 = Math.round(".$this_magi5.");
var mg6 = Math.round(".$this_magi6.");
var mg7 = Math.round(".$this_magi7.");
var mg8 = Math.round(".$this_magi8.");
var mg9 = Math.round(".$this_magi9.");
var mg10 = Math.round(".$this_magi10.");
var mg11 = Math.round(".$this_magi11.");
var mg12 = Math.round(".$this_magi12.");
var mg13 = Math.round(".$this_magi13.");
var mg14 = Math.round(".$this_magi14.");
var mg15 = Math.round(".$this_magi15.");
var mg16 = Math.round(".$this_magi16.");
var mg17 = Math.round(".$this_magi17.");
var mg18 = Math.round(".$this_magi18.");
var mg19 = Math.round(".$this_magi19.");
";
}

if ($cur_hudsubsidy=="Yes")
{
echo "var hud1 = Math.round(".$this_hud1.");
var hud2 = Math.round(".$this_hud2.");
var hud3 = Math.round(".$this_hud3.");
var hud4 = Math.round(".$this_hud4.");
var hud5 = Math.round(".$this_hud5.");
var hud6 = Math.round(".$this_hud6.");
var hud7 = Math.round(".$this_hud7.");
var hud8 = Math.round(".$this_hud8.");
var hud9 = Math.round(".$this_hud9.");
var hud10 = Math.round(".$this_hud10.");
var hud11 = Math.round(".$this_hud11.");
var hud12 = Math.round(".$this_hud12.");
var hud13 = Math.round(".$this_hud13.");
var hud14 = Math.round(".$this_hud14.");
var hud15 = Math.round(".$this_hud15.");
var hud16 = Math.round(".$this_hud16.");
var hud17 = Math.round(".$this_hud17.");
var hud18 = Math.round(".$this_hud18.");
var hud19 = Math.round(".$this_hud19.");
";
}

echo "var sp1 = Math.round(".$this_spendingpower1.");
var sp2 = Math.round(".$this_spendingpower2.");
var sp3 = Math.round(".$this_spendingpower3.");
var sp4 = Math.round(".$this_spendingpower4.");
var sp5 = Math.round(".$this_spendingpower5.");
var sp6 = Math.round(".$this_spendingpower6.");
var sp7 = Math.round(".$this_spendingpower7.");
var sp8 = Math.round(".$this_spendingpower8.");
var sp9 = Math.round(".$this_spendingpower9.");
var sp10 = Math.round(".$this_spendingpower10.");
var sp11 = Math.round(".$this_spendingpower11.");
var sp12 = Math.round(".$this_spendingpower12.");
var sp13 = Math.round(".$this_spendingpower13.");
var sp14 = Math.round(".$this_spendingpower14.");
var sp15 = Math.round(".$this_spendingpower15.");
var sp16 = Math.round(".$this_spendingpower16.");
var sp17 = Math.round(".$this_spendingpower17.");
var sp18 = Math.round(".$this_spendingpower18.");
var sp19 = Math.round(".$this_spendingpower19.");
";
...
/*
echo "<br><br><span style=\"color:red;\" >DOLLASNAP_LimitPercent_Standard==".$SNAP_LimitPercent_Standard." (spreadsheet D10 from db)</span><br><br>";
